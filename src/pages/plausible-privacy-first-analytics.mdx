...
_"Web analytics went from a simple, fun, and useful practice for site owners to a data grabbing machine for surveillance capitalism. Google Analytics is frustrating to use, difficult to understand, slow to load, and privacy-invasive too."_
