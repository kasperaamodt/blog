...
<Picture src={dashboard} height={310} width={570} aspectRatio={1647/896} widths={[300, 400, 480, 570]} sizes="(min-width: 570px) 570px, 100vw" alt="Plausible Analytics dashboard" />
