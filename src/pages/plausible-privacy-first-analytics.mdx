...
<Picture src={dashboard} height={896} width={1647} aspectRatio={1647/896} widths={[300, 400, 480, 570]} sizes="(min-width: 570px) 570px, 100vw" alt="Plausible Analytics dashboard" />
