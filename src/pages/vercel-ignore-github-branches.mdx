...
<Picture src={before} widths={[300, 400, 480, 570]} sizes="(min-width: 570px) 570px, 100vw" alt="GitHub pull request without dependabot" />

But now, after the script, it looks like this:

<Picture src={after} widths={[300, 400, 480, 570]} sizes="(min-width: 570px) 570px, 100vw" alt="GitHub pull request with dependabot" />
...
<Picture src={buildstep} widths={[300, 400, 480, 570]} sizes="(min-width: 570px) 570px, 100vw" alt="Vercel project settings -> git -> ignored build step" />
